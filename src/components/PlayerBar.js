			...
			<section className="player-bar">
				...
				<section id="buttons">
					<div className="btn-group" role="group" aria-label="Basic example">
						<button id="previous" className="btn btn-outline-success" type="button" onClick={this.props.handlePrevClick}>
							<span className="ion-skip-backward" />
						</button>
						<button id="play-pause" className="btn btn-outline-success" type="button" onClick={this.props.handleSongClick}>
							<span className={this.props.isPlaying ? 'ion-pause' : 'ion-play'} />
						</button>
						<button id="next" className="btn btn-outline-success" type="button" onClick={this.props.handleNextClick}>
